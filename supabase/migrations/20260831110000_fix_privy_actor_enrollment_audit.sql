-- Audit outcome is an execution result, while the actor lifecycle state remains
-- pending for regulated roles. Keep those two concepts separate.
...
begin
  ...
  values (new_actor_ref, 'actor.enrolled', new_actor_ref, 'allowed', prior_audit_digest, new_audit_digest);
