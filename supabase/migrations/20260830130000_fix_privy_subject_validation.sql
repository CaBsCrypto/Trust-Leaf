-- PostgreSQL's regular-expression engine limits repetition counts below the
-- former 500 upper bound. Keep the same accepted Privy DID shape while
-- validating its length separately.
