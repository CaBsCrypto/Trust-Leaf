...
function App() {
  const [direction, setDirection] = useState<'A' | 'B' | 'C' | 'D'>('D');
  ...
  const title = page === 'home' ? direction === 'D' ? 'Jornada' : 'Tu jornada, en orden.' : page === 'attention' ? review ? 'Revisar entrega' : patient ? patient.name : 'Pacientes autorizados' : pageLabel;
