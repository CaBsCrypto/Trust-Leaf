    ...
    <section className="relative min-h-[86vh] overflow-hidden bg-brand-green-deep text-brand-ivory">
      <div aria-hidden="true" className="absolute inset-0">
        ...
        <img
          ...
          alt=""
          className="absolute bottom-8 right-[4%] hidden h-[48%] w-[31%] object-cover opacity-70 [mask-image:radial-gradient(ellipse_at_center,black_42%,transparent_72%)] md:block"
          referrerPolicy="no-referrer"
        />
        <img
          src="https://images.pexels.com/photos/29612649/pexels-photo-29612649.jpeg?auto=compress&cs=tinysrgb&w=1200"
          alt=""
          className="absolute right-[22%] top-[13%] hidden h-[38%] w-[26%] object-cover opacity-60 [mask-image:radial-gradient(ellipse_at_center,black_38%,transparent_74%)] lg:block"
          referrerPolicy="no-referrer"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-brand-green-deep via-brand-green-deep/74 to-brand-green-deep/28" />
        <div className="absolute inset-0 bg-brand-green-deep/18" />
      </div>
