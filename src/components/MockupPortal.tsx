...
function buildDefaultDoctorAgenda(baseDate: Date): DoctorAgendaBlock[] {
  ...
  return buildLiveDoctorAvailabilitySlots(baseDate).map(([date, time, status], index) => ({
    ...
    reason: status === 'Reservado' ? 'Primera consulta y revisiÃ³n de historial' : undefined,
...
function normalizeDemoText(value: unknown) {
  ...
  return value
    ...
    .replaceAll('organico', 'orgÃ¡nico')

    .replaceAll('analgesico', 'analgÃ©sico')

    .replaceAll('traumatologico', 'traumatolÃ³gico')

    .replaceAll('cronico', 'crÃ³nico')
  ...
  { 
    ...
    inventory: [
      ...
      { 
        ...
        recommendation: "Recomendado para: Fatiga mental y cuadros de depresiÃ³n leve.",

        origin: "Altas Cumbres - CÃ³rdoba, AR",

        lab: "QC-882 â¢ EcoAnalytica",

        harvestDate: "Abril 2026",

        batch: "Lote: LH-2026-Z42",

        description: "Con un aroma cÃ­trico punzante, Lemon Haze ofrece un impulso cerebral inmediato, perfecto para mantener la productividad.",
      ...
      { 
        ...
        effect: "Equilibrado / EufÃ³rico",

        recommendation: "Recomendado para: NÃ¡useas post-quimioterapia y falta de apetito.",

        origin: "Valle Inferior - Chubut, AR",

        lab: "QC-112 â¢ Patagonia Lab",

        harvestDate: "Febrero 2026",

        batch: "Lote: BD-2026-P09",

        description: "Una de las cepas mÃ¡s versÃ¡tiles, Blue Dream combina la relajaciÃ³n fÃ­sica de la Ã­ndica con la chispa mental de la sativa.",
...

      {
        ...
        origin: "Delta del ParanÃ¡ - Buenos Aires, AR",

        lab: "QC-441 â¢ Delta Labs",
  ...
  { 
    ...
    inventory: [
      ...
      { 
        ...
        effect: "AnsiolÃ­tico / Suave",

        recommendation: "Recomendado para: Ansiedad social y uso terapÃ©utico equilibrado.",

        origin: "Valle de la Luna - San Juan, AR",

        lab: "QC-771 â¢ BioTrust",

        harvestDate: "Enero 2026",

        batch: "Lote: DF-2026-S11",

        description: "Deep Forest es excelente para quienes buscan los beneficios terapÃ©uticos del CBD sin un efecto psicoactivo abrumador.",
      ...
      { 
        ...
        effect: "NarcÃ³tico / FÃ­sico",

        recommendation: "Recomendado para: Dolor neuropÃ¡tico severo y espasmos musculares.",

        origin: "Pircas del Sol - La Rioja, AR",

        lab: "QC-334 â¢ SolLabs",

        harvestDate: "Mayo 2026",

        batch: "Lote: PK-2026-K88",

        description: "Una cepa clÃ¡sica de las montaÃ±as, famosa por su coloraciÃ³n pÃºrpura y su capacidad para inducir un sueÃ±o profundo.",
...

      {
        ...
        recommendation: "Recomendado para: EstrÃ©s post-traumÃ¡tico y migraÃ±as severas.",

        origin: "Valle de Uco - Mendoza, AR",

        lab: "QC-229 â¢ Andes Lab",
  ...
  { 
    ...
    inventory: [
      ...
      { 
        ...
        effect: "Medicinal / LÃºcido",

        recommendation: "Recomendado para: NiÃ±os con epilepsia refractaria y casos de inflamaciÃ³n severa.",

        origin: "Vivero Nacional - Buenos Aires, AR",

        lab: "QC-001 â¢ ANMAT Oficial",

        harvestDate: "Mayo 2026",

        batch: "Lote: CP-2026-F01",

        description: "Cepa de grado farmacÃ©utico, desarrollada bajo estrictos estÃ¡ndares para pacientes que requieren CBD de alta pureza.",
      ...
      { 
        ...
        recommendation: "Recomendado para: Fatiga crÃ³nica y estimulaciÃ³n del enfoque cognitivo.",

        origin: "Invernaderos del Este - Uruguay (Importado)",

        lab: "QC-552 â¢ Mercosur AnalÃ­tica",

        harvestDate: "Abril 2026",

        batch: "Lote: WW-2026-M22",

        description: "Una leyenda global refinada en laboratorios regionales para maximizar su consistencia terapeÃºtica.",
...

      {
        ...
        origin: "Granjas del Sur - NeuquÃ©n, AR",

        lab: "QC-993 â¢ Patagonian Bio",
...
const DISPENSARY_INVENTORY_SEED = [

  {
    ...
    effect: 'Equilibrado / analgÃ©sico',
...

  {
    ...
    origin: 'Cultivo orgÃ¡nico - Mendoza',
...
const PRIVATE_CLINICAL_DOSSIER = [

  {
    ...
    title: 'SÃ­ntomas reportados',

    status: 'Privado',

    summary: 'Dolor crÃ³nico lumbar, dificultad para dormir y episodios de ansiedad.',

    details: ['EvoluciÃ³n registrada por el paciente', 'Escala de dolor: 7/10', 'Frecuencia: diaria', 'Ãltima actualizaciÃ³n: hace 6 dÃ­as'],
...

  {
    ...
    title: 'ExÃ¡menes y respaldos',

    status: 'Validado',

    summary: 'Resonancia, informe traumatolÃ³gico y certificado de tratamiento previo.',
...

  {
    ...
    title: 'Historial terapÃ©utico',

    status: 'Listo para médico',

    summary: 'Tratamientos previos, respuesta a dosis y tolerancia del paciente.',

    details: ['AINEs con respuesta parcial', 'Fisioterapia documentada', 'Uso cannabis medicinal supervisado', 'Alertas de interacciÃ³n: sin registros crÃ­ticos'],
...
const DOCTOR_SESSION_PATIENTS = [

  {
    ...
    reason: 'Dolor crÃ³nico lumbar',

    status: 'Listo para revisar',

    lastVisit: 'Control en 30 dÃ­as',
...

  {
    ...
    reason: 'Ansiedad y dolor neuropÃ¡tico',

    status: 'Seguimiento activo',

    lastVisit: 'Hace 14 dÃ­as',
...
const MOCK_GLOBAL_REGIONS = [

  {
    ...
    requirements: ['Documento ID', 'ValidaciÃ³n Trust'],

    description: 'DESTINO TOP 1: Marco progresivo con eventos internacionales prÃ³ximamente. Acceso mediante clubes certificados.'
...

  {
    ...
    description: 'DESTINO TOP 2: Acceso federal garantizado. ValidaciÃ³n inmediata de su tratamiento médico habitual.'
...

  {
    ...
    partner: 'AsociaciÃ³n CannÃ¡bica MVD',

    flag: 'ðºð¾',

    continent: 'AmÃ©rica',

    requirements: ['Documento de identidad', 'ValidaciÃ³n Trust Leaf'],

    description: 'Pioneros en regulaciÃ³n. Acceso simple para pacientes internacionales validados.'
...

  {
    ...
    description: 'Protocolos estrictos de la UE. Su receta tiene validez transatlÃ¡ntica.'
...

  {
    ...
    description: 'Altos estÃ¡ndares farmacÃ©uticos. Protocolos HIPAA en dispensarios premium de South Beach.'
...
const MOCK_GLOBAL_DISPENSARIES: Record<string, any[]> = {
  ...
  'reg-prt': [
    ...
    { id: 'disp-prt-1', name: 'Lisboa Social Club', address: 'Av. da Liberdade, 100', rating: 4.9, distance: 'Cerca de Barrio Alto', inventory: [
      ...
      { id: 's-prt-1', name: 'Algarve Kush', type: 'Indica', thc: '21%', terpenes: 'Mirceno', effects: 'SedaciÃ³n profunda' }
  ...
  'reg-ury': [
    ...
    { id: 'disp-ury-1', name: 'Montevideo Cannabis Club', address: 'Bulevar Artigas 1200', rating: 4.9, distance: 'A 2.4km de tu ubicaciÃ³n', inventory: [

      { id: 's-ury-1', name: 'Punta del Este Gold', type: 'Sativa Dominant', thc: '22%', terpenes: 'Limoneno, Pineno', effects: 'Euforia, Creatividad' },

      { id: 's-ury-2', name: 'RÃ­o de la Plata Kush', type: 'Indica dominant', thc: '19%', terpenes: 'Mirceno, Cariofileno', effects: 'RelajaciÃ³n, AnalgÃ©sico' }
  ...
  'reg-usa-mia': [
    ...
    { id: 'disp-usa-1', name: 'Miami Beach Wellness', address: 'Collins Ave, Miami Beach', rating: 4.8, distance: 'South Beach', inventory: [
      ...
      { id: 's-usa-1', name: 'Sunshine State OG', type: 'Hybrid', thc: '25%', terpenes: 'Cariofileno', effects: 'Euforia, RelajaciÃ³n' }
...
export default function MockupPortal({
  ...
  const [doctorIssueForm, setDoctorIssueForm] = useState({
    ...
    treatment: 'Cannabis medicinal para manejo de dolor crÃ³nico',

    dosage: '0.5g por vÃ­a vaporizada cada 12 horas',

    notes: 'Control clínico en 30 dÃ­as.',
  ...
  const [stellarTxStep, setStellarTxStep] = useState<'sis' | 'build' | 'sign' | 'submit' | 'validate' | null>(null);
  ...
  const [regionFilter, setRegionFilter] = useState<'Todos' | 'AmÃ©rica' | 'Europa' | 'OceanÃ­a'>('Todos');
  ...
  const [recentActivity, setRecentActivity] = useState(() => {
    ...
    return saved ? JSON.parse(saved) : [
      ...
      { id: 'act-init-3', action: "SincronizaciÃ³n con Red", date: "Ayer", icon: "Search" }
        ...
        if (active) {
          ...
          const approvedDisps = dispResult.records
            ...
            .map((disp) => ({
              ...
              address: disp.address || "DirecciÃ³n Registrada",

              distance: "UbicaciÃ³n verificada",
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      if (!isFirstSnapshot && isDispensaryPortal) {
        ...
        if (newPending.length > 0) {
          ...
          showToast(`ð Nuevo retiro pendiente recibido en cola`, 'info');
  ...
  const connectPasskeyWallet = async (attachment?: 'platform' | 'cross-platform') => {
    ...
    try {
      ...
      setWalletHint(
        ...
        'Passkey conectada en testnet. Si quieres mÃ¡s resiliencia, ahora puedes vincular Freighter como respaldo.',
    ...
    try {
      ...
      setWalletHint(
        ...
        walletSetup.primaryMethod === 'passkey'
          ...
          ? 'Freighter quedÃ³ vinculada como mÃ©todo alternativo sobre testnet.'
  ...
  const resetDemoState = () => {
    ...
    setRecentActivity([
      ...
      { id: 'act-reset-1', action: 'Flujo reiniciado para revision', date: 'ReciÃ©n', icon: 'Activity' },
  ...
  const linkFreighterBackup = async () => {
    ...
    try {
      ...
      setWalletHint(
        ...
        'Freighter quedÃ³ agregada como signer de respaldo para tu smart wallet de passkey en testnet.',
  ...
  const resetWalletSetup = async () => {
    ...
    try {
      ...
      // 1. Limpiar base de datos hÃ­brida local y credenciales
      ...
      dosage:
        ...
        prescription.status === 'used'
          ...
          : prescription.status === 'expired'
            ...
            ? 'La receta expiró en testnet y requiere nueva emisiÃ³n médica.'

            : 'Receta vigente. El documento médico completo se resuelve off-chain.',

      notes: `Tx ${shortenHash(prescription.txHash)} â¢ Ledger ${prescription.issuedLedger}`,
  ...
  const generatePrescriptionPDF = async (prescriptionId: string, doctorName: string, doctorEmail: string, patientName: string, patientAddress: string, treatment: string, dosage: string) => {
    ...
    try {
      ...
      doc.text('RECETA MÃDICA MAGISTRAL CANNÁBICA', 15, 27);
      ...
      doc.text(`Fecha EmisiÃ³n: ${new Date().toLocaleDateString('es-CL')}`, 130, 28);
      ...
      doc.text('1. INFORMACIÃN DEL PACIENTE', 15, 55);
      ...
      doc.text('2. PRESCRIPCIÃN CLÃNICA Y DOSIFICACIÃN', 15, 95);
      ...
      doc.text('Instrucciones de DosificaciÃ³n:', 15, dosageY);
      ...
      const legalText = 'Esta receta médica magistral se emite bajo el amparo de la legislaciÃ³n chilena vigente (Ley 20.000, Ley 21.572 y decretos del Ministerio de Salud). Autoriza la adquisiciÃ³n de preparados medicinales en locales autorizados y el autocultivo personal/domÃ©stico con fines de tratamiento médico exclusivo segÃºn las especificaciones anteriores.';
      ...
      doc.text('QR de ValidaciÃ³n CriptogrÃ¡fica', 15, signY + 39);
      ...
      console.log(`[PDF] Receta #${prescriptionId} descargada con Ã©xito.`);
  ...
  const handleDoctorIssuePrescription = async () => {
    ...
    if (!targetPatientAddress) {
      ...
      setDoctorIssueError('Ingresa la direcciÃ³n Stellar del paciente para emitir la receta.');
    ...
    try {
      ...
      if (doctorIssueForm.doctorRut) {
        ...
        if (!verifySisResp.ok) {
          ...
          throw new Error(verifySisPayload.message || 'La validaciÃ³n ante la Superintendencia de Salud (SIS) fallÃ³.');
      ...
      const vehicleLabels: Record<string, string> = {
        ...
        flower: 'Flor Seca VaporizaciÃ³n',

        cream: 'Crema TÃ³pica Emoliente',

        capsule: 'CÃ¡psula Magistral',
      ...
      const compoundingDetail = `FÃ³rmula: ${vehicleLabels[doctorIssueForm.vehicle] || 'Preparado'} | THC ${doctorIssueForm.thcRatio}% / CBD ${doctorIssueForm.cbdRatio}%`;

      const autocultivoDetail = doctorIssueForm.enableAutocultivo

        ? ` | Ley 21.57 protection: RegiÃ³n ${doctorIssueForm.autocultivoRegion}, Comuna ${doctorIssueForm.autocultivoComuna}, DirecciÃ³n ${doctorIssueForm.autocultivoAddress}, LÃ­mite ${doctorIssueForm.autocultivoPlants} macetas`
      ...
      if (signingMethod === 'freighter') {
        ...
        if (!freighterInstalled) {
          ...
          throw new Error('La extensiÃ³n Freighter no estÃ¡ instalada o habilitada.');

        }

        const freighterConn = await connectFreighterOnTestnet();

        setStellarTxStep('build');
        ...
        if (!buildResp.ok) {
          ...
          throw new Error(buildPayload.message || 'Error construyendo la transacciÃ³n para Freighter.');

        }



        setStellarTxStep('sign');
        const signedXdr = await signXdrWithFreighter(buildPayload.xdr);



        setStellarTxStep('submit');
        ...
        if (!submitResp.ok) {
          ...
          throw new Error(submitPayload.message || 'Error al transmitir la transacciÃ³n firmada.');
      ...
      setDoctorIssueSuccess(
        ...
        `Receta emitida en testnet. NÃºmero ${issuedId ?? 'pendiente'} - Tx ${shortenHash(txHash)}`,

      );

      showToast(`â Receta #${issuedId ?? 'N/A'} emitida y registrada en Testnet`);
      ...
      if (issuedId !== undefined && issuedId !== null) {
        ...
        // Generar y descargar el PDF de forma automÃ¡tica
  ...
  const saveConsultationSummaryToRecord = async (statusOverride?: ConsultationStatus) => {
    ...
    try {
      ...
      // Derivar secreto compartido ECDH usando la llave privada del médico y pÃºblica del paciente

      const sharedAESKey = await deriveSharedAESKey(doctorKeyPair.privateKey, patientKeyPair.publicKey);



      // Cifrar el diagnÃ³stico y resumen clínico
    ...
    const nextRecord: PrivateClinicalRecord = {
      ...
      details: [
        ...
        `Fecha y hora: ${selectedConsultationBlock.date} Â· ${selectedConsultationBlock.time}`,
    ...
    // Guardar en Firestore usando trustDataStore para persistencia hÃ­brida
    ...
    setRecentActivity((prev: any[]) => [

      {
        ...
        action: `Resumen clinico cifrado y guardado Â· ${savedAt}`,
      ...
      setConsultationClinicalRecords((prev) => {
        ...
        return [

          {
            ...
            summary: `${selectedConsultationBlock.reason ?? 'Consulta médica finalizada'} Â· ${completedAt}.`,

            details: [

              `AtenciÃ³n realizada por ${clinicalAccessDoctor}`,

              `Fecha y hora: ${selectedConsultationBlock.date} Â· ${selectedConsultationBlock.time}`,

              `Motivo: ${selectedConsultationBlock.reason ?? 'RevisiÃ³n clínica'}`,
  ...
  useEffect(() => {
    ...
    setDoctorIssueForm((prev) => ({
      ...
      treatment: prev.treatment || 'Cannabis medicinal para manejo de dolor crÃ³nico',

      notes: selectedConsultationBlock.reason

        ? `${selectedConsultationBlock.reason}. Control clínico en 30 dÃ­as.`
  ...
  const issueDemoPrescription = (targetPatientAddress: string) => {
    ...
    if (selectedConsultationBlock) {
      ...
      setConsultationClinicalRecords((prev) => {
        ...
        const prescriptionDetail = `Receta #${issuedId} asociada Â· hash ${shortenHash(txHash)} Â· cupo ${doctorIssueForm.monthlyLimitGrams}g`;
        ...
        return [

          {
            ...
            summary: `${selectedConsultationBlock.reason ?? 'Consulta médica'} Â· receta #${issuedId} generada.`,
            ...
            details: [
              ...
              'DiagnÃ³stico y notas completas permanecen cifrados off-chain',
  ...
  const registerLocalDispense = (prescriptionId: number, mode: 'demo' | 'fallback') => {
    ...
    setDispenseSuccess(
      ...
      mode === 'demo'
        ...
        : 'El contrato testnet marcÃ³ esta receta sin cupo activo. Trust Leaf conserva un retiro fraccionado privado mientras la siguiente versiÃ³n de contratos maneja gramos restantes por periodo.',
  ...
  const handleCompleteOnchainDispense = async () => {
    ...
    if (!Number.isFinite(prescriptionId)) {
      ...
      setDispenseError('Ingresa el nÃºmero de receta on-chain que emitiÃ³ el médico.');
    ...
    try {
      ...
      if (signingMethod === 'freighter') {
        ...
        if (!buildResp.ok) {
          ...
          throw new Error(buildPayload.message || 'Error construyendo la transacciÃ³n de dispensaciÃ³n.');
        ...
        if (!submitResp.ok) {
          ...
          throw new Error(submitPayload.message || 'Error transmitiendo la dispensaciÃ³n.');
      ...
      showToast(`â DispensaciÃ³n #${recordId ?? 'N/A'} confirmada en Testnet`);
  ...
  const handleRetainPrescription = async () => {
    ...
    if (!Number.isFinite(prescriptionId)) {
      ...
      setRetainReleaseError('NÃºmero de receta no vÃ¡lido para retenciÃ³n.');
    ...
    try {
      ...
      if (signingMethod === 'freighter') {
        ...
        if (!buildResp.ok) {
          ...
          throw new Error(buildPayload.message || 'Error construyendo la retenciÃ³n para Freighter.');
        ...
        if (!submitResp.ok) {
          ...
          throw new Error(submitPayload.message || 'Error al transmitir la retenciÃ³n.');
        ...
        if (!response.ok) {
          ...
          throw new Error(payload.message || 'No fue posible registrar la retenciÃ³n criptogrÃ¡fica.');
      ...
      setRetainReleaseSuccess(
        ...
        `RetenciÃ³n criptogrÃ¡fica exitosa en testnet. Receta bloqueada por ${lockPeriodDays} dÃ­as. Tx: ${txHash.slice(0, 8)}...`

      );

      showToast(`ð Receta #${prescriptionId} retenida por ${lockPeriodDays} dÃ­as en Testnet`);
      ...
      // Actualizar la validaciÃ³n de la receta on-chain

      await validatePrescriptionOnTestnet();

    } catch (err: any) {

      setRetainReleaseError(err.message || 'Error en la transacciÃ³n de retenciÃ³n.');
  ...
  const handleReleasePrescription = async () => {
    ...
    if (!Number.isFinite(prescriptionId)) {
      ...
      setRetainReleaseError('NÃºmero de receta no vÃ¡lido para liberaciÃ³n.');
    ...
    try {
      ...
      if (signingMethod === 'freighter') {
        ...
        if (!buildResp.ok) {
          ...
          throw new Error(buildPayload.message || 'Error construyendo la liberaciÃ³n para Freighter.');
        ...
        if (!submitResp.ok) {
          ...
          throw new Error(submitPayload.message || 'Error al transmitir la liberaciÃ³n.');
      ...
      setRetainReleaseSuccess(`Receta liberada con Ã©xito en testnet. Devuelta al paciente. Tx: ${txHash.slice(0, 8)}...`);

      showToast(`ð Receta #${prescriptionId} liberada al paciente en Testnet`);
      ...
      setRetainReleaseError(err.message || 'Error en la transacciÃ³n de liberaciÃ³n.');
  ...
  const drawerMeta: Record<ActionDrawerKey, { eyebrow: string; title: string; description: string }> = {
    ...
    'doctor-consultation': {
      ...
      description: 'Valida llegada por QR, inicia la atenciÃ³n y mantiene visible el estado de la sesiÃ³n.',
    ...
    'doctor-clinical-summary': {
      ...
      description: 'Registra solo lo necesario para el tratamiento. La informaciÃ³n clínica queda bajo control del paciente.',
    ...
    'patient-permissions': {
      ...
      description: 'Revisa quiÃ©n puede acceder a datos o recetas y revoca permisos cuando lo necesites.',
    ...
    'patient-record': {
      ...
      description: 'SÃ­ntomas, exÃ¡menes y consultas se comparten solo con consentimiento temporal.',
    ...
    'patient-prescription': {
      ...
      description: 'Genera QR para dispensario y revisa saldo disponible sin exponer diagnÃ³stico.',
    ...
    'patient-traceability': {
      ...
      description: 'Consulta entregas parciales, lote, cantidad y prueba pÃºblica de cada retiro.',
            ...
            <div className="rounded-3xl border border-brand-green-deep/10 bg-white p-5">
              ...
              <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <input
                  ...
                  placeholder="Paciente si ya estÃ¡ reservado"
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-3xl border border-brand-green-deep/10 bg-white p-5">
              ...
              <p className="mt-2 text-sm leading-relaxed text-brand-green-mid/65">
                ...
                {selectedConsultationBlock
                  ...
                  ? `${selectedConsultationBlock.date} Â· ${selectedConsultationBlock.time} Â· ${selectedConsultationBlock.reason ?? 'Consulta médica'}`
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              >
                ...
                <p className="mt-2 text-xs leading-relaxed text-brand-ivory/65">Abre la sesiÃ³n clínica y habilita resumen/receta.</p>
            ...
            <div className="rounded-3xl border border-brand-green-deep/10 bg-white p-5">
              ...
              <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-2xl bg-brand-neutral/60 p-4">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-widest text-brand-green-mid/45">LÃ­mite mensual</p>
        ...
        return (
          ...
          <div className="space-y-4">
            ...
            {privacyPermissions.length ? privacyPermissions.map((permission) => (
              ...
              <div key={permission.id} className="rounded-2xl glass-panel border border-brand-green-light/10 p-4">
              ...
              <div className="rounded-2xl border border-dashed border-brand-green-deep/15 bg-brand-neutral/30 p-5 text-sm text-brand-green-mid/65">
                ...
                AÃºn no hay permisos activos. El paciente decide cuÃ¡ndo compartir su ficha o receta.
          ...
          <div className="space-y-4">
            ...
            {(patientDashboard?.prescriptions ?? []).map((prescription) => (
              ...
              <button key={prescription.id} type="button" onClick={() => openOnchainPrescription(prescription)} className="w-full rounded-2xl border border-brand-green-deep/10 bg-white p-4 text-left">
                ...
                <p className="mt-1 text-xs text-brand-green-mid/65">{prescription.status} Â· {formatPortalDate(prescription.issuedAt)}</p>
        ...
        return (
          ...
          <div className="space-y-4">
            ...
            {activePickups.length ? activePickups.map((pickup) => (
              ...
              <div key={pickup.id} className="rounded-2xl glass-panel border border-brand-green-light/10 p-4">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-brand-green-mid/65">{pickup.quantity}g Â· {pickup.dispensary?.name ?? 'Dispensario autorizado'}</p>
              ...
              <div className="rounded-2xl border border-dashed border-brand-green-deep/15 bg-brand-neutral/30 p-5 text-sm text-brand-green-mid/65">
                ...
                Las entregas aparecerÃ¡n aquÃ­ con lote, cantidad y prueba verificable.
        ...
        return (
          ...
          <div className="space-y-5">
            ...
            {dispensaryInventory.map((product) => (
              ...
              <div key={product.id} className="rounded-2xl glass-panel border border-brand-green-light/10 p-4">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-brand-green-mid/65">{product.batch} Â· {product.stockGrams}g Â· THC {product.thc} / CBD {product.cbd}</p>
          ...
          <div className="space-y-5">
            ...
            {cart.length ? (
              ...
              cart.map((item) => (
                ...
                <div key={item.strain.id} className="rounded-2xl glass-panel border border-brand-green-light/10 p-4">
  ...
  return (
    ...
    <AnimatePresence>
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {/* â Toast Notification Overlay âââââââââââââââââââââââââââââââââââ */}
            ...
            <AnimatePresence>
              ...
              {toastMessage && (
                ...
                >
                  ...
                  <button onClick={() => setToastMessage(null)} className="ml-1 opacity-70 hover:opacity-100">Ã</button>
            ...
            <div className="hidden md:flex w-64 bg-brand-green-deep p-6 text-brand-ivory flex-col gap-8">
              ...
              <nav className="flex flex-col gap-2">
                ...
                <motion.button 
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl text-sm font-medium transition-colors ${activeView === 'overview' ? 'bg-white/10 text-brand-ivory shadow-premium border border-brand-green-light/20' : 'text-white/60 hover:bg-white/5'}`}
                ...
                <motion.button 
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl text-sm font-medium transition-colors ${activeView === 'doctors' ? 'bg-white/10 text-brand-ivory shadow-premium border border-brand-green-light/20' : 'text-white/60 hover:bg-white/5'}`}
                ...
                <motion.button 
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl text-sm font-medium transition-colors ${activeView === 'dispensaries' ? 'bg-white/10 text-brand-ivory shadow-premium border border-brand-green-light/20' : 'text-white/60 hover:bg-white/5'}`}

                >

                  <ShoppingBag size={18} /> {isDispensaryPortal ? 'OperaciÃ³n' : t.portal.navDispensaries}
                ...
                <motion.button 
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl text-sm font-medium transition-colors ${activeView === 'prescriptions' ? 'bg-white/10 text-brand-ivory shadow-premium border border-brand-green-light/20' : 'text-white/60 hover:bg-white/5'}`}
                ...
                <motion.button 
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl text-sm font-medium transition-colors ${activeView === 'pickups' ? 'bg-white/10 text-brand-ivory shadow-premium border border-brand-green-light/20' : 'text-white/60 hover:bg-white/5'}`}
                ...
                <motion.button 
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl text-sm font-medium transition-colors ${activeView === 'history' ? 'bg-white/10 text-brand-ivory shadow-premium border border-brand-green-light/20' : 'text-white/60 hover:bg-white/5'}`}
                ...
                <motion.button 
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl text-sm font-medium transition-colors ${activeView === 'traveler' ? 'bg-white/10 text-brand-ivory shadow-premium border border-brand-green-light/20' : 'text-white/60 hover:bg-white/5'}`}
              ...
              {!isDoctorPortal && !isDispensaryPortal ? (
                ...
                >
                  ...
                  <p className="text-sm font-medium">Ropa, calzado y productos de caÃ±amo</p>
            ...
            <div className="flex-1 overflow-y-auto bg-white mb-[80px] md:mb-0">
              ...
              <div className="sticky top-0 bg-white/80 backdrop-blur-md z-10 px-6 md:px-8 py-4 md:py-6 border-b border-brand-green-deep/5 flex justify-between items-center">
                ...
                <h3 className="text-xl md:text-2xl font-serif text-brand-green-deep">
                  ...
                  {activeView === 'dispensaries' && (isDispensaryPortal ? 'OperaciÃ³n dispensario' : t.portal.viewDispensaries)}
                ...
                <AnimatePresence mode="wait" key="portal-content-transitions">
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-6">
                              ...
                              <div className="flex items-start justify-between gap-4">
                                ...
                                <div>
                                  ...
                                  <p className="mt-1 text-sm text-brand-green-mid/70">
                                    ...
                                    {patientUpcomingConsultation.date} Â· {patientUpcomingConsultation.time}
                        ...
                        <div className="bg-brand-neutral/40 rounded-[32px] border border-brand-green-deep/5 p-6">
                          ...
                          <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-brand-gold mb-2">Ãltima receta</p>
                          ...
                          {patientDashboardLoading ? (
                              ...
                              <div className="flex items-center justify-between gap-4">
                                ...
                                <div>
                                  ...
                                  <p className="mt-2 text-sm text-brand-green-mid/70">
                                    ...
                                    EmisiÃ³n {formatPortalDate(primaryPrescription.issuedAt)}
                            ...
                            <div className="rounded-3xl bg-white p-6 border border-dashed border-brand-green-deep/10">
                              ...
                              <p className="text-sm text-brand-green-mid/70">
                                ...
                                Esta wallet todavÃ­a no tiene recetas emitidas en la ventana actual de eventos de testnet.
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        >
                          ...
                          <p className="text-xl font-bold text-brand-green-deep mb-1">
                            ...
                            {primaryPrescription ? 'Cannabis terapÃ©utico' : 'Sin receta vigente'}
                        ...
                        >
                          ...
                          <p className="text-xs text-brand-green-mid/70">A 1.2km â¢ Stock Disponible</p>

                          <div className="mt-4 flex items-center gap-2 text-[10px] font-bold text-brand-gold uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">

                            {hasPrescription ? 'Abrir catÃ¡logo' : 'Solicitar Acceso'} <ArrowRight size={12} />
                  ...
                  {activeView === 'profile' && isViewAllowed('profile') && (
                    ...
                    >
                      ...
                      <div className="rounded-[32px] glass-panel shadow-premium border border-brand-green-light/10 p-6 md:p-8">
                    ...
                    <div className="space-y-6">
                      ...
                      {isDoctorPortal && showTechnicalDetails && (
                        ...
                        <div className="grid grid-cols-1 gap-4 xl:grid-cols-[0.9fr_1.1fr]">
                          ...
                          <div className="rounded-[28px] glass-panel shadow-premium border border-brand-green-light/10 p-5 md:p-6">
                      ...
                      {isDoctorPortal && (
                        ...
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-4">
                          ...
                          <ActionCard
                            ...
                            status={doctorSignerReady ? 'Listo' : 'RevisiÃ³n'}
                            ...
                            <div>
                              ...
                              <p className="mt-1 text-sm text-brand-green-mid/70">
                                ...
                                {selectedConsultationBlock
                                  ...
                                  ? `${selectedConsultationBlock.date} Â· ${selectedConsultationBlock.time}`

                                  : 'La consulta abre el acceso a ficha privada, seguimiento y emisiÃ³n de receta.'}

                              </p>

                              <p className="mt-2 max-w-2xl text-sm text-brand-green-mid/65">

                                {selectedConsultationBlock?.reason ?? 'Usa el botÃ³n Consulta en un bloque reservado para traer el paciente a esta mesa de trabajo.'}
                        ...
                        <div key={`portal-doctor-${doc.id}`} className="p-5 border border-brand-green-deep/5 rounded-2xl grid grid-cols-[auto_1fr] gap-4 hover:shadow-md transition-shadow">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-1 text-xs text-brand-gold font-bold">
                              ...
                              <Star size={14} fill="currentColor" /> {doc.rating.toFixed(1)} <span className="text-brand-green-mid/40 font-medium">({doc.reviews} reseÃ±as)</span>
                          ...
                          <div className="col-span-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-4 border-t border-brand-green-deep/5">
                            ...
                            <span className="text-[10px] text-center uppercase tracking-widest text-brand-green-mid font-bold opacity-60">PrÃ³xima: {doc.availability}</span>
                          ...
                          <div className="rounded-[28px] border border-brand-green-deep/10 bg-white p-5 md:p-6 shadow-sm">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-brand-gold">Cola de DispensaciÃ³n en Tiempo Real (Firestore)</p>
                                ...
                                <div key={pickup.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-4 first:pt-0 last:pb-0 gap-4">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-xs text-brand-green-mid/70">
                                      ...
                                      Cantidad: <span className="font-bold text-brand-green-deep">{pickup.quantity}g</span> â¢ Paciente ID: <span className="font-mono text-brand-gold">{pickup.patientId?.slice(-6)}</span> â¢ Token: <span className="font-mono text-brand-green-deep">{pickup.token}</span>
                          ...
                          <div className="rounded-[28px] glass-panel shadow-premium border border-brand-green-light/10 p-5 md:p-6">
                            ...
                            <div className="mt-4 border-t border-brand-green-deep/5 pt-4">
                              ...
                              {signingMethod === 'freighter' && !freighterInstalled && (
                                ...
                                <div className="mt-2 p-2 rounded-xl bg-amber-50 text-amber-800 text-[11px] border border-amber-200">
                                  ...
                                  <p className="font-bold">â ï¸ Freighter no detectado</p>

                                  <p className="mt-0.5">Necesitas la extensiÃ³n para firmar localmente.</p>
                                ...
                                {prescriptionValidation ? (
                                  ...
                                  <>
                                    ...
                                    <p className="mt-2 font-mono text-xs">
                                      ...
                                      Paciente {shortenAddress(prescriptionValidation.prescription.patient, 8)} Â· Doctor {shortenAddress(prescriptionValidation.prescription.doctor, 8)}
                              ...
                              <div className="mt-4 rounded-2xl border border-brand-green-deep/10 bg-brand-neutral/50 p-5">
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <h4 className="text-[10px] font-bold uppercase tracking-widest text-brand-green-mid/70">
                                    ...
                                    Custodia CriptogrÃ¡fica de la Receta (Stellar Ledger)
                                ...
                                {prescriptionValidation.prescription.status === 'retained' ? (
                                    ...
                                    {(!prescriptionValidation.prescription.retainedBy || prescriptionValidation.prescription.retainedBy === currentUserWallet) ? (
                                      ...
                                      <div className="mt-4">
                                        ...
                                        <div className="flex items-center gap-2 rounded-xl bg-amber-50/70 p-3 text-xs text-amber-800 border border-amber-200/50">
                                          ...
                                          <p>Bloqueo criptogrÃ¡fico activo por permanencia legal. El paciente no puede retirar el NFT antes del plazo.</p>
                                        ...
                                        >
                                          ...
                                          {retainReleaseBusy ? 'Liberando Receta...' : 'ð Solicitar LiberaciÃ³n Administrativa'}
                                      ...
                                      <p className="mt-3 text-xs text-red-700 font-bold">
                                        ...
                                        â No tienes permisos para dispensar ni liberar esta receta (retenida por otra entidad).
                                  ...
                                  <div className="mt-3">
                                    ...
                                    <p className="text-xs text-brand-green-mid/80">
                                      ...
                                      El paciente puede comprometer su receta para iniciar preparados magistrales. Selecciona el perÃ­odo de permanencia mÃ­nima en Stellar:
                                    ...
                                    <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center">
                                      ...
                                      >
                                        ...
                                        <option value={30}>30 dÃ­as (Piloto Corto)</option>

                                        <option value={90}>90 dÃ­as (Mediano Plazo)</option>

                                        <option value={180}>180 dÃ­as (6 meses - Permanencia Recomendada)</option>
                                      ...
                                      >
                                        ...
                                        {retainReleaseBusy ? 'Procesando...' : 'ð Retener Receta'}
                            ...
                            <div className="mt-5 grid grid-cols-2 gap-3">
                              ...
                              {[
                                ...
                                ['Estado', dispensarySignerReady ? 'Operativo' : 'ValidaciÃ³n interna'],
                        ...
                        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-brand-green-mid/60 mt-2 max-w-2xl">
                              ...
                              Cada tarjeta representa un producto/lote del dispensario. Ajusta stock si entra o sale mercaderÃ­a, o prepara una dispensa para validar la receta del paciente.
                                ...
                                <div key={pickup.id} className="flex flex-col gap-3 rounded-2xl border border-brand-green-deep/5 bg-brand-neutral/35 p-4 sm:flex-row sm:items-center sm:justify-between">
                                  ...
                                  <div>
                                    ...
                                    <p className="mt-1 text-xs text-brand-green-mid/60">
                                      ...
                                      {pickup.quantity}g Â· {pickup.dispensary?.name ?? 'Dispensario operador'} Â· receta validada
                        ...
                        <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1fr_0.72fr]">
                          ...
                          <div
                            ...
                            onClick={() => setSelectedPrescription({
                              ...
                              notes: "AcompaÃ±amiento por dolor crÃ³nico lumbar. Control en 30 dÃ­as."
                            ...
                            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                              ...
                              <div className="flex items-start gap-4">
                                ...
                                <div>
                                  ...
                                  <h4 className="text-xl font-bold text-brand-green-deep">Tratamiento dolor crÃ³nico</h4>
                            ...
                            <div key={`portal-dispensary-${disp.id}`} className="p-6 bg-brand-neutral/30 rounded-2xl border border-brand-green-deep/5">
                               ...
                               <div className="space-y-2 mb-6">
                                  ...
                                  <div className="flex items-center gap-2 text-xs text-brand-green-mid/60">
                                     ...
                                     <MapPin size={14} /> {disp.address} â¢ {disp.distance}
                  ...
                  {activeView === 'prescriptions' && (
                    ...
                    {!hasPrescription ? (
                       ...
                       <div className="bg-brand-neutral/30 border-2 border-dashed border-brand-green-deep/10 rounded-[40px] p-12 text-center">
                          ...
                          <p className="text-brand-green-mid/60 text-sm max-w-xs mx-auto mb-8">Cuando un médico emita tu receta, aparecerÃ¡ acÃ¡ y podrÃ¡s usarla en dispensarios.</p>
                      ...
                      <span>Este es un ejemplo de cÃ³mo verÃ¡s tus recetas legales emitidas por nuestra red.</span>
                    ...
                    <div 
                      ...
                      onClick={() => setSelectedPrescription({
                        ...
                        dosage: "0.5g p/vÃ­a vaporizada cada 12hs",
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <h4 className="font-bold text-brand-green-deep">Tratamiento Dolor CrÃ³nico</h4>

                          <p className="text-sm text-brand-green-mid/70">Dr. Alejandro Merino â¢ Emitida Hoy</p>
                      ...
                      <>
                        ...
                        {activePickups.length === 0 ? (
                          ...
                          <div className="bg-white border-2 border-dashed border-brand-green-deep/10 rounded-[40px] p-12 text-center">
                             ...
                             <p className="text-brand-green-mid/60 text-sm max-w-xs mx-auto">Cuando adquieras una medicina en un dispensario, aquÃ­ aparecerÃ¡ tu token de retiro.</p>
                          ...
                          <div className="grid grid-cols-1 gap-3 lg:grid-cols-3">
                            ...
                            <div className="rounded-3xl bg-brand-green-deep p-5 text-brand-ivory lg:col-span-1">
                              ...
                              <p className="mt-2 text-sm text-brand-ivory/60">Tokens listos para presentar en dispensario. No exponen diagnÃ³stico ni notas clínicas.</p>
                        ...
                        <AnimatePresence mode="wait">
                          ...
                          {pickupStep === 'scanning' && (
                            ...
                            >
                               ...
                               <p className="text-brand-green-mid/60 text-sm">El dispensario estÃ¡ sincronizando con su billetera...</p>
                          ...
                          {pickupStep === 'success' && (
                            ...
                            >
                               ...
                               <p className="text-brand-green-mid/70 text-sm mb-10 px-6">
                                  ...
                                  La medicina ha sido entregada exitosamente. La transacciÃ³n ha sido registrada en el historial de su receta.
                  ...
                  >
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 mb-6">
                        ...
                        <div>
                          ...
                          <p className="mt-2 text-sm text-brand-ivory/65 max-w-2xl">
                            ...
                            SÃ­ntomas, exÃ¡menes y respaldos quedan cifrados. En otro paÃ­s el médico recibe pruebas verificables y documentos autorizados por el paciente, no datos abiertos por defecto.
                          ...
                          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            ...
                            <div className="flex items-center gap-4 w-full sm:w-auto">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-[11px] text-brand-green-mid/70 truncate">{order.dispensary} â¢ {order.date}</p>
                    ...
                    <div className="mt-12 p-8 bg-brand-neutral/30 rounded-[40px] border border-dashed border-brand-green-deep/10 text-center">
                       ...
                       <p className="text-xs text-brand-green-mid/50 font-medium max-w-sm mx-auto">
                         ...
                         Trust Leaf utiliza tecnologÃ­a blockchain para asegurar que cada gramo de medicina sea rastreable desde el cultivo hasta sus manos. Esta informaciÃ³n es auditable y protege su derecho al acceso legal.
                      ...
                      <>
                        ...
                        <div className="bg-[#0A2619] rounded-[32px] md:rounded-[48px] p-6 md:p-12 text-brand-ivory relative overflow-hidden border border-white/5">
                           ...
                           <div className="relative z-10 max-w-xl">
                              ...
                              <p className="text-sm md:text-base text-brand-ivory/60 mb-10 leading-relaxed">Activa una credencial médica privada para presentar receta vigente, identidad y evidencia mÃ­nima en destinos compatibles.</p>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                           ...
                           <div className="flex flex-wrap gap-2">
                              ...
                              {['Todos', 'AmÃ©rica', 'Europa', 'OceanÃ­a'].map(tab => (
                      ...
                      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between flex-wrap gap-4">
                           ...
                           <div className="flex items-center gap-3">
                              ...
                              <span className="text-xs font-bold text-brand-green-mid/40 uppercase tracking-widest">Sincronizado vÃ­a {selectedRegion.partner}</span>
                        ...
                        <div className="bg-white rounded-[32px] md:rounded-[40px] border border-brand-green-deep/5 p-8 md:p-12 relative overflow-hidden">
                           ...
                           <div className="relative z-10">
                              ...
                              <p className="text-sm md:text-base text-brand-green-mid/70 max-w-2xl">
                                ...
                                Todos los establecimientos listados a continuaciÃ³n han completado la integraciÃ³n con Trust Leaf. Su historial de salud y receta digital serÃ¡ verificado automÃ¡ticamente al ingresar con su cÃ³digo QR.
                                 ...
                                 <div className="flex-1">
                                    ...
                                    <div className="space-y-4 mb-8">
                                       ...
                                       <div className="p-4 bg-brand-neutral rounded-[20px] border border-brand-green-deep/5">
                                          ...
                                          <p className="text-[10px] font-bold text-brand-green-mid/40 uppercase tracking-widest mb-1">Perfil TerpÃ©nico</p>
                                    ...
                                    >
                                       ...
                                       {cart.find(c => c.strain.id === strain.id) ? (
                                         ...
                                         <> <ShoppingBag size={18} /> AÃ±adir a la Bolsa Global </>
                    ...
                    <div className="p-6 md:p-10 bg-brand-neutral rounded-[32px] border border-brand-green-deep/5 flex flex-col md:flex-row items-center gap-6">
                       ...
                       <div className="text-center md:text-left">
                          ...
                          <p className="text-[13px] text-brand-green-mid/70 leading-relaxed max-w-2xl">
                             ...
                             Trust Leaf actÃºa como orÃ¡culo de datos criptogrÃ¡ficos entre sistemas de salud nacionales. El acceso a la medicina en el extranjero estÃ¡ sujeto a las leyes locales. Siempre verifique las regulaciones del paÃ­s de destino antes de compartir su credencial médica.
              ...
              <div className="p-6 border-b border-brand-green-deep/5 flex justify-between items-center bg-white sticky top-0 z-10">
                ...
                <div>
                   ...
                   <h4 className="text-xl font-serif text-brand-green-deep">
                     ...
                     {bookingStep === 'success' ? 'Â¡Cita Confirmada!' : 'Agendar tu Consulta'}
                 ...
                 <AnimatePresence mode="wait" key="booking-step-transitions">
                    ...
                    {bookingStep === 'time' && (
                      ...
                      <motion.div key="step-time" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
                         ...
                         <button onClick={() => setBookingStep('date')} className="mb-4 text-xs font-bold text-brand-gold uppercase tracking-widest flex items-center gap-1">â Cambiar fecha</button>
                    ...
                    {bookingStep === 'success' && (
                      ...
                      <motion.div key="step-success" initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="py-12 text-center">
                         ...
                         <p className="text-brand-green-mid/70 text-sm mb-8 px-4">Hemmos enviado la confirmaciÃ³n a tu correo y hemos notificado al {bookingDoctor.name}.</p>
                      ...
                      <motion.div key="step-inventory" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
                         ...
                         <div className="flex justify-between items-end mb-6">
                            ...
                            <div>
                               ...
                               <p className="text-xs font-bold text-brand-gold uppercase tracking-[0.2em] mb-1">CatÃ¡logo Disponible</p>
                         ...
                         <div className="mb-5 rounded-3xl border border-brand-green-deep/5 bg-white p-5">
                            ...
                            {cartExceedsPrescriptionLimit && (
                              ...
                              <p className="mt-3 rounded-xl border border-red-100 bg-red-50 p-3 text-xs text-red-700">
                                ...
                                Este carrito supera el cupo disponible de la receta. Reduce gramos o solicita actualizaciÃ³n médica.
                         ...
                         <div className="mt-8 p-6 bg-brand-green-deep/5 rounded-3xl border border-brand-green-deep/5 flex items-center gap-4">
                            ...
                            <div>
                               ...
                               <p className="text-[11px] text-brand-green-mid/60 mt-1">Todas las cepas en este catÃ¡logo poseen el sello Trust Leaf de trazabilidad digital.</p>
                      ...
                      <motion.div key="step-validate" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
                            ...
                            <div className="relative z-10">
                               ...
                               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                  ...
                                  <div className="space-y-6 relative ml-4">
                                     ...
                                     <div className="relative flex items-start gap-4">
                                        ...
                                        <div>
                                           ...
                                           <p className="text-[10px] text-brand-ivory/40 mt-1">AnÃ¡lisis de pureza completo</p>
                                 ...
                                 <div className="bg-white/5 p-6 rounded-3xl border border-white/10 relative overflow-hidden">
                                     ...
                                     <p className="text-[10px] font-bold text-brand-gold uppercase tracking-widest mb-4 relative z-10">ComposiciÃ³n de Cannabinoides</p>
                         ...
                         <div className="space-y-4">
                            ...
                            <div className="p-5 bg-brand-neutral/50 rounded-3xl border border-brand-green-deep/5 mb-4">
                               ...
                               <p className="text-[10px] font-bold text-brand-green-mid/40 uppercase tracking-widest mb-2">PrescripciÃ³n de Uso</p>
                      ...
                      <motion.div key="step-confirm" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
                         ...
                         <div className="space-y-4">
                            ...
                            <div className="rounded-xl border border-blue-100 bg-blue-50 p-3 text-xs text-blue-700">
                              ...
                              Agente 402: confirma que la receta pertenece al paciente y mantiene cupo disponible, sin revelar diagnÃ³stico. Cada entrega registra solo prueba, lote y cantidad.

                            </div>

                            <div className="rounded-xl border border-amber-100 bg-amber-50 p-3 text-xs text-amber-800">

                              PrÃ³xima versiÃ³n: los contratos guardarÃ¡n gramos restantes por periodo para permitir retiros parciales en distintos dispensarios.
                            ...
                            <label className="block space-y-2">
                              ...
                              <div className="rounded-2xl glass-panel border border-brand-green-light/10 p-4">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div className="md:col-span-2 grid grid-cols-1 gap-4 sm:grid-cols-2 rounded-2xl border border-brand-gold/15 bg-[#fbf7ef]/40 p-4">
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <p className="mt-1 text-xs text-brand-green-mid/70">IdentificaciÃ³n inequivoca requerida para la validez legal del autocultivo y la receta magistral.</p>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {doctorIssueForm.doctorRut && (
                          ...
                          <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded-full ${
                            ...
                            {validateRut(doctorIssueForm.doctorRut) ? 'VÃ¡lido' : 'InvÃ¡lido'}
                    ...
                    <label className="space-y-1">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-widest text-brand-green-mid/50">NÂº Registro SIS (Superintendencia)</span>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {doctorIssueForm.patientRut && (
                          ...
                          <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded-full ${
                            ...
                            {validateRut(doctorIssueForm.patientRut) ? 'VÃ¡lido' : 'InvÃ¡lido'}
                    ...
                    <label className="space-y-1">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-widest text-brand-green-mid/50">DiagnÃ³stico CIE-10</span>
                      ...
                      >
                        ...
                        <option value="G43.9">CIE-10: G43.9 - MigraÃ±a, no especificada</option>

                        <option value="M25.5">CIE-10: M25.5 - Dolor en articulaciÃ³n</option>

                        <option value="G80.9">CIE-10: G80.9 - ParÃ¡lisis cerebral, no especificada</option>

                        <option value="C61">CIE-10: C61 - Tumor maligno de la prÃ³stata (Paliativo)</option>
                  ...
                  <label className="space-y-2">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-brand-green-mid/50">Vigencia en dÃ­as</span>
                  ...
                  <div className="md:col-span-2 rounded-2xl border border-brand-green-deep/10 bg-[#edf2ee]/40 p-4">
                    ...
                    <p className="text-[11px] font-bold uppercase tracking-wider text-brand-gold">FÃ³rmula Recetario Magistral (Chile)</p>

                    <p className="mt-1 text-xs text-brand-green-mid/70">Selecciona el formato farmacÃ©utico y la concentraciÃ³n exacta de fitocannabinoides.</p>
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
                      ...
                      {[
                        ...
                        { id: 'oil', label: 'Aceite Sublingual', desc: 'VehÃ­culo oleoso' },

                        { id: 'flower', label: 'Flor Vaporizada', desc: 'InhalaciÃ³n seca' },

                        { id: 'cream', label: 'Crema Emoliente', desc: 'Uso dÃ©rmico' },

                        { id: 'capsule', label: 'CÃ¡psula Magistral', desc: 'VÃ­a oral' },
                  ...
                  <div className="md:col-span-2 rounded-2xl border border-brand-green-deep/10 bg-[#edf2ee]/40 p-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] font-bold uppercase tracking-wider text-brand-gold">ProtecciÃ³n de Autocultivo (Ley 21.575)</p>
                      ...
                      <div className="mt-4 space-y-3 border-t border-brand-green-deep/5 pt-3 animate-fade-in">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <label className="space-y-1">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest text-brand-green-mid/50">RegiÃ³n</span>
                        ...
                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                          ...
                          <label className="sm:col-span-2 space-y-1">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest text-brand-green-mid/50 font-bold">DirecciÃ³n de Cultivo Autorizada</span>
                          ...
                          <label className="space-y-1">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest text-brand-green-mid/50 font-bold">NÂº de Macetas</span>
                  ...
                  <div className="md:col-span-2 rounded-2xl border border-brand-green-deep/10 bg-[#fbf7ef] p-4">
                    ...
                    <p className="text-[10px] font-bold uppercase tracking-widest text-brand-gold font-bold">MÃ©todo de Firma de TransacciÃ³n</p>
                    ...
                    {signingMethod === 'freighter' && !freighterInstalled && (
                      ...
                      <div className="mt-3 p-3 rounded-xl bg-amber-50 text-amber-800 text-xs border border-amber-200 flex flex-col gap-1.5">
                        ...
                        <p className="font-bold">â ï¸ ExtensiÃ³n Freighter no detectada</p>

                        <p>Para firmar localmente, necesitas instalar la extensiÃ³n Freighter en tu navegador. De lo contrario, la emisiÃ³n fallarÃ¡.</p>
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-5 p-6 md:grid-cols-[180px_1fr]">
                ...
                <div className="rounded-3xl glass-panel shadow-premium border border-brand-green-light/10 p-4 shadow-sm">
                ...
                {selectedClinicalRecord.summary.includes('[Cifrado') && (
                  ...
                  <div className="rounded-2xl border border-brand-gold/30 bg-[#fbf7ef] p-4 flex flex-col gap-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <p className="text-[10px] uppercase tracking-widest text-brand-gold font-bold">ð Resguardo de Privacidad Zero-Knowledge</p>
                    ...
                    <p className="text-xs text-brand-green-mid/70 leading-relaxed">
                      ...
                      Este registro clínico se encuentra cifrado de extremo a extremo (E2EE) en Firestore. Solo tÃº con tus llaves criptogrÃ¡ficas (asociadas a tu Passkey) puedes descifrarlo en tu navegador local.
                        ...
                        try {
                          ...
                          setSelectedClinicalRecord(prev => prev ? {
                            ...
                            details: [
                              ...
                              'ð Registro descifrado exitosamente de forma local en el navegador del paciente.'
                          ...
                          showToast('ð Ficha clínica descifrada localmente con Ã©xito');

                        } catch (err) {

                          console.error(err);

                          alert('Error al descifrar el registro: Llaves invÃ¡lidas o firmas corruptas.');
                    ...
                    >
                      ...
                      <span>ð Descifrar Ficha (Passkey Smart Wallet)</span>
                ...
                <div className="rounded-2xl glass-panel border border-brand-green-light/10 p-4">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] uppercase tracking-widest text-brand-green-mid/45 font-bold mb-1">ExÃ¡menes y documentos</p>
                ...
                <div className={`rounded-2xl border p-4 text-xs leading-relaxed ${
                  ...
                  {selectedClinicalAccess === 'authorized'
                    ...
                    : selectedClinicalAccess === 'revoked'
                      ...
                      ? `Acceso revocado para ${authorizedDoctorName}. El médico conserva solo el hash pÃºblico y pierde la ventana temporal de lectura privada.`
                ...
                <div className="rounded-2xl border border-brand-gold/20 bg-brand-gold/5 p-4">
                  ...
                  <p className="mt-2 text-[10px] leading-relaxed text-brand-green-mid/55">
                    ...
                    {selectedClinicalAccess === 'authorized'
                      ...
                      ? `Permiso temporal para ${authorizedDoctorName}: permiso-${selectedClinicalRecord.id}-24h - expira maÃ±ana.`

                      : selectedClinicalAccess === 'revoked'

                        ? `RevocaciÃ³n para ${authorizedDoctorName}: revoke-${selectedClinicalRecord.id}-402.`
              ...
              <div className="flex-1 overflow-y-auto p-5 md:p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  ...
                  {[
                    ...
                    ['Comprobante de transacciÃ³n', shortenHash(selectedTraceRecord.txHash ?? '', 10)],
                ...
                <div className="rounded-2xl border border-blue-100 bg-blue-50 p-4 text-xs text-blue-700 leading-relaxed">
                  ...
                  Agente 402 muestra prueba verificable, lote y estado de entrega, sin revelar diagnÃ³stico ni notas clínicas completas. Los hashes completos quedan disponibles para auditorÃ­a tÃ©cnica, pero la vista del paciente prioriza informaciÃ³n entendible.
            ...
            >
              ...
              <div className="flex items-start justify-between gap-4 border-b border-brand-green-deep/5 bg-brand-neutral/30 p-6">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-xl text-sm leading-relaxed text-brand-green-mid/65">
                    ...
                    Marcas y productores que trabajan con cÃ¡Ã±amo, fibras naturales y derivados no medicinales. Separado del flujo clínico y de dispensaciÃ³n.
              ...
              <div className="grid grid-cols-1 gap-3 p-6 sm:grid-cols-3">
                ...
                {[
                  ...
                  ['Indumentaria de caÃ±amo', 'Ropa tecnica, textiles y prendas regenerativas.', 'CÃ¡Ã±amo textil'],

                  ['Calzado y accesorios', 'Zapatillas, bolsos y materiales de fibra vegetal.', 'DiseÃ±o circular'],
              ...
              <div className="border-t border-brand-green-deep/5 bg-brand-neutral/30 p-6">
                ...
                {cannabisMarketInterest && (
                  ...
                  <div className="mb-3 rounded-2xl border border-green-100 bg-green-50 p-3 text-xs text-green-700">
                    ...
                    InterÃ©s registrado. Esta secciÃ³n abrirÃ¡ el directorio de marcas y solicitudes para nuevos negocios del ecosistema.
                ...
                >
                  ...
                  {cannabisMarketInterest ? 'InterÃ©s registrado' : 'Explorar negocios aliados'}
      ...
      <AnimatePresence mode="wait" key="modal-prescription-details">
            ...
            >
              ...
              <div className="p-6 md:p-8 border-b border-brand-green-deep/5 flex justify-between items-center bg-brand-neutral/30">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold text-brand-gold uppercase tracking-[0.2em] mt-1">ValidaciÃ³n Digital Trust Leaf</p>
              ...
              <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 sm:hidden">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-bold text-brand-green-mid/40 uppercase mb-1">F. EmisiÃ³n</p>
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-bold text-brand-green-mid/40 uppercase mb-1">VÃ¡lida Hasta</p>
                  ...
                  <div className="hidden sm:block">
                    ...
                    <p className="text-[10px] font-bold text-brand-green-mid/40 uppercase mb-1">Fecha de EmisiÃ³n</p>
                ...
                <div className="p-4 bg-brand-neutral rounded-2xl">
                   ...
                   <p className="text-[10px] font-bold text-brand-green-mid/40 uppercase mb-2">PrescripciÃ³n TerapÃ©utica</p>
                   ...
                   <div className="pt-3 border-t border-brand-green-deep/5">
                      ...
                      <p className="text-[10px] font-bold text-brand-green-mid/40 uppercase mb-1">DosificaciÃ³n</p>
                ...
                <div className="p-4 border border-brand-gold/20 rounded-2xl bg-brand-gold/5">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <p className="text-[10px] font-bold text-brand-gold uppercase tracking-widest">ValidaciÃ³n On-Chain</p>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[9px] text-brand-green-mid/40 italic">
                      ...
                      // Esta receta ha sido anclada en la blockchain para validaciÃ³n pÃºblica descentralizada por dispensarios autorizados.
                 ...
                 <button
                   ...
                   onClick={async () => {
                     ...
                     await generatePrescriptionPDF(
                       ...
                       selectedPrescription.dosage || 'Dosis personalizada segÃºn receta magistral'
        ...
        {stellarTxStep !== null && (
          <motion.div
            key="stellar-tx-loader"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-brand-green-deep/90 backdrop-blur-xl"
          >
            <motion.div
              initial={{ scale: 0.9, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.9, opacity: 0 }}
              className="bg-white rounded-[32px] p-8 max-w-md w-full shadow-2xl border border-brand-green-light/10 text-center space-y-6"
            >
              <div className="relative w-24 h-24 mx-auto">
                <div className="absolute inset-0 rounded-full border-4 border-brand-green-deep/10" />
                <motion.div
                  animate={{ rotate: 360 }}
                  transition={{ repeat: Infinity, duration: 1.5, ease: "linear" }}
                  className="absolute inset-0 rounded-full border-4 border-transparent border-t-brand-green-glow"
                />
                <div className="absolute inset-0 flex items-center justify-center text-brand-green-deep">
                  <Database className="w-8 h-8 animate-pulse text-brand-green-glow" />
                </div>
              </div>

              <div>
                <h4 className="text-xl font-serif text-brand-green-deep">Procesando Stellar Blockchain...</h4>
                <p className="text-xs text-brand-green-mid/60 mt-1">Transacción criptográfica segura autorizada por contratos Soroban</p>
              </div>

              <div className="space-y-4 text-left border-t border-brand-green-deep/5 pt-4">
                <div className="flex items-center gap-3">
                  <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold ${
                    stellarTxStep === 'sis' || stellarTxStep === 'validate'
                      ? 'bg-brand-green-glow text-white animate-pulse'
                      : stellarTxStep === 'build' || stellarTxStep === 'sign' || stellarTxStep === 'submit'
                        ? 'bg-brand-green-deep text-brand-ivory'
                        : 'bg-brand-neutral text-brand-green-deep/30'
                  }`}>
                    1
                  </div>
                  <p className={`text-sm ${
                    stellarTxStep === 'sis' || stellarTxStep === 'validate'
                      ? 'text-brand-green-deep font-bold'
                      : 'text-brand-green-deep/60'
                  }`}>
                    {stellarTxStep === 'validate' ? 'Validando receta on-chain...' : 'Verificando licencia médica con SIS...'}
                  </p>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold ${
                    stellarTxStep === 'build'
                      ? 'bg-brand-green-glow text-white animate-pulse'
                      : stellarTxStep === 'sign' || stellarTxStep === 'submit'
                        ? 'bg-brand-green-deep text-brand-ivory'
                        : 'bg-brand-neutral text-brand-green-deep/30'
                  }`}>
                    2
                  ...
                  <p className={`text-sm ${
                    ...
                    Compilando transacción Soroban...
                  </p>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className={`text-sm ${
                    ...
                    Esperando firma digital de billetera...
                  </p>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className={`text-sm ${
                    ...
                    Registrando en Stellar Testnet Ledger...
                  </p>
                </div>
              </div>

              <div className="text-[10px] font-mono text-brand-green-deep/40 bg-brand-neutral/40 rounded-xl p-3">
                No cierres esta ventana hasta completar el registro on-chain.
              </div>
            </motion.div>
          </motion.div>
        )}
