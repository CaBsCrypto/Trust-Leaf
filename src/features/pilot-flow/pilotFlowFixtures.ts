import type { PilotPhaseDefinition } from './pilotFlowMachine.ts';

export const PILOT_QR_HANDLE = 'demo_qr_7Fj3nK8qP2vM6xR4';

export const PILOT_PHASES: readonly PilotPhaseDefinition[] = [
  ...
  { phase: 'receipt-active', journeyStep: 7, role: 'doctor', eyebrow: 'Receipt local', title: 'Receipt preparado en modo simulado', summary: 'La UI refleja el estado esperado de ReceiptLedgerV2; no firma, envía ni consulta la red.', status: 'Activo · fixture v1', source: 'gate-local' },
  ...
  { phase: 'dispense-partial', journeyStep: 9, role: 'dispensary', eyebrow: 'Verificación mínima', title: 'Evento parcial registrado', summary: 'El QR opaco coincide y se registra un evento local con estado mínimo.', status: 'Parcial · fixture v2', source: 'gate-local' },
  { phase: 'dispense-complete', journeyStep: 9, role: 'dispensary', eyebrow: 'Cierre sintético', title: 'Evento total registrado', summary: 'El receipt pasa a consumido en la simulación y un segundo uso queda bloqueado.', status: 'Dispensado · fixture v3', source: 'gate-local' },
