export const pilotActions = ['snapshot', 'join', 'save-profile', 'create-organization', 'add-operator', 'remove-operator',
...
export type PilotSnapshot = { joined: boolean; synthetic: true; role: PilotRole; actorRef: string; asOf?: string; staffOnly?: boolean;
  profile?: PatientProfile | null; patientProfiles?: PatientProfile[];
